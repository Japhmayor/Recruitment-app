...
//Uncomment roles to perform role specific actions
namespace JobPortal.Controllers
{
    public class JobController : Controller
    {
        ...
        // get a list of all jobs from the database
        [Route("jobs")]
        ...
        public async Task<IActionResult> Apply(int id)
        {
            ...
            {
                //if user is not employee, stop am!
        ...
        //mark a job as filled from the dashboard
